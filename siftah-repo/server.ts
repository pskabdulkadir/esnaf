...
// Default initial data for simulation and operation
const INITIAL_DATA = {
  products: [
    {
      id: "prod-1",
      ...
      price: 34.00,
      stockQuantity: 42,
      stockLimit: 30, // threshold
      category: "Süt ve Kahvaltılık",
      expiryDate: "2026-06-23", // Expiring in 3 days
      isSpecialDiscount: false,
      lastUpdated: "2026-06-19T10:00:00.000Z"
    },
    {
      id: "prod-2",
      name: "Karaköy Poğaçası (Adet)",
      price: 12.00,
      stockQuantity: 110,
      stockLimit: 60, // Overstock!
      category: "Fırın & Unlu Mamül",
      expiryDate: "2026-06-21",
      isSpecialDiscount: false,
      lastUpdated: "2026-06-20T07:00:00.000Z"
    },
    {
      id: "prod-3",
      name: "Mevsim Meyvesi: Taze Çilek (Kg)",
      price: 65.00,
      stockQuantity: 48,
      stockLimit: 25, // Overstock!
      category: "Manav",
      expiryDate: "2026-06-24",
      isSpecialDiscount: false,
      lastUpdated: "2026-06-19T15:30:00.000Z"
    },
    {
      id: "prod-4",
      name: "Ev Yapımı Kayseri Mantısı (500g)",
      price: 195.00,
      stockQuantity: 15,
      stockLimit: 30,
      category: "Dondurulmuş & Hazır Yemek",
      expiryDate: "2026-09-15",
      isSpecialDiscount: true, // Special merchant push
      lastUpdated: "2026-06-18T11:20:00.000Z"
    },
    {
      id: "prod-5",
      name: "Süzme Süzme Yoğurt (2Kg)",
      price: 75.00,
      stockQuantity: 14,
      stockLimit: 25,
      category: "Süt ve Kahvaltılık",
      expiryDate: "2026-06-21", // Expiring tomorrow!
      isSpecialDiscount: false,
      lastUpdated: "2026-06-19T09:00:00.000Z"
    },
    {
      id: "prod-6",
      name: "Sıcak Çikolatalı Kek (Dilim)",
      price: 45.00,
      stockQuantity: 8,
      stockLimit: 15,
      category: "Tatlı & Atıştırmalık",
      expiryDate: "2026-06-22",
      isSpecialDiscount: true, // Special discount mark
      lastUpdated: "2026-06-20T08:15:00.000Z"
    }
  ],
  customers: [
    { id: "cust-1", fullName: "Aysel Teyze", phone: "+90 532 111 2233", segment: "Ev Hanımları", isSubscribed: true, notes: "Günlük süt ve mantı tutkunu." },
    { id: "cust-2", fullName: "Korkut Serdar", phone: "+90 555 444 5566", segment: "Gençler", isSubscribed: true, notes: "Atıştırmalıklar ve tezgah poğaçası seviyor." },
    { id: "cust-3", fullName: "Naim Dayı (Muhtar)", phone: "+90 542 777 8899", segment: "Genel", isSubscribed: true, notes: "Mahalle bakkalı müdavimi." },
    { id: "cust-4", fullName: "Sibel Hanım", phone: "+90 505 333 4455", segment: "Ev Hanımları", isSubscribed: true, notes: "Taze meyve ve sebze alıcısı." },
    { id: "cust-5", fullName: "Umut Can (Öğrenci)", phone: "+90 539 222 1100", segment: "Gençler", isSubscribed: true, notes: "Okul dönüşü simit poğaça alır." },
    { id: "cust-6", fullName: "Fatma Teyze", phone: "+90 531 999 8877", segment: "Ev Hanımları", isSubscribed: true, notes: "Taze yoğurt ve börekleri sorar." }
  ],
  campaigns: [
    {
      id: "camp-hist-1",
      productId: "prod-2",
      productName: "Karaköy Poğaçası (Adet)",
      originalPrice: 12.00,
      discountPrice: 8.50,
      targetSegment: "Gençler",
      messageContent: "🚨 GENÇLERE ÖZEL FIRINDAN SICAK FIKRA! Selam beyler, bayanlar! Karaköy'den yeni çıkmış çıtır çıtır poğaçalar bakkalımızda sizi bekliyor! Çaylar demlendi, ders arası açlığına 12 TL değil SADECE 8.50 TL! Koşun, soğumadan kapın! 🏃‍♂️🥯",
      deliveryTime: "11:00 - 13:00 (Öğle Arası)",
      status: "Gönderildi",
      createdAt: "2026-06-19T08:00:00.000Z",
      approvedAt: "2026-06-19T08:05:00.000Z",
      sentCount: 2,
      logs: [
        "19/06/2026 11:15:02 - Twilio API Bağlantısı Başarılı.",
        "19/06/2026 11:15:04 - Gönderiliyor: 'Korkut Serdar' (+90 555 444 5566) - İletildi.",
        "19/06/2026 11:15:07 - Spam Karşıtı Gecikme Devrede: 3000ms beklendi.",
        "19/06/2026 11:15:10 - Gönderiliyor: 'Umut Can (Öğrenci)' (+90 539 222 1100) - İletildi.",
...
app.post("/api/generate-marketing", async (req, res) => {
  ...
  // Choose a campaign premise styled to Turkish local neighbourhood/bakkal vibes
  const prompt = `
Yerel bir Türk mahalle esnafı (bakkal, fırın, manav) için sosyal medya / WhatsApp pazarlama metni yazacaksın. 
...
2. "Gençler" ise:
   ...
   - Örnek başlangıç: "Gençler selam! 🚨 Açlık krizlerine son..." veya "Öğrenci dostu bakkalınızdan bomba haber!"
...
3. "Genel" ise:
   ...
   - Örnek başlangıç: "Hayırlı sabahlar sevgili mahalle sakinleri...", "Bizim bakkaldan günün haberi..."
...
app.post("/api/public-discounts", (req, res) => {
  ...
  const newPublicDiscount = {
    ...
    merchantName: merchantName || "Bizim Mahalle Bakkalı",
...
app.post("/api/generate-seo-meta", async (req, res) => {
  ...
  const mName = merchantName || "Bizim Mahalle Bakkalı";
  ...
  const prompt = `
Aşağıdaki ürün ve indirim bilgileri için Google, Yandex ve sosyal medya platformlarında (WhatsApp, Twitter vb.) en yüksek tıklamayı alacak SEO uyumlu Meta Bilgilerini oluştur.
${langInstruction}
...
function getFallbackSeoMeta(productName: string, discountPrice: number, category: string, merchantName: string, lang: string) {
  ...
  return {
    ...
    seoDescription: `${merchantName}'da taptaze indirim! ${productName} kısa süreliğine dev indirimle sadece ${discountPrice} TL. Kaçırmadan dükkana uğrayın!`,
    seoKeywords: `${productName.toLowerCase()} indirim, ucuz bakkal fiyatları, mahalle indirimleri, en yakın bakkal taze ${category.toLowerCase()}`,
    recommendedImage: image
  };
}
